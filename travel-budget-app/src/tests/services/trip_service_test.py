...
class TestTripService(unittest.TestCase):
    ...
    def test_new_trip(self):
        ...
        self.assertRaises(
            EmptyInputError, lambda: self.trip_serivce.new_trip("", "", "10"))
        self.assertRaises(
            EmptyInputError, lambda: self.trip_serivce.new_trip("gabi", "", ""))
        self.assertRaises(
            NotIntegerError, lambda: self.trip_serivce.new_trip("gabi", "trip1", "abc"))
        self.assertRaises(NotIntegerError, lambda: self.trip_serivce.new_trip(
            "gabi", "trip1", "10.99"))
